...
const CategoriaInsumos = () => {
    const [categorias, setCategorias] = useState([
        { id: 1, nombre: "Cuidado Capilar", descripcion: "Productos para el cuidado del cabello", estado: "Activo" },
        { id: 2, nombre: "Coloración", descripcion: "Tintes y colorantes para el cabello", estado: "Inactivo" },
    ]);
    ...
    const saveCategoria = (nuevaCategoria) => {
        if (modal.type === "agregar") {
            ...
            setCategorias(categorias.map(c => (c.id === nuevaCategoria.id ? nuevaCategoria : c)));
        }
        closeModal();
    };
                        ...
                        <tbody>
                            {filteredCategorias.map(categoria => (
                                <tr key={categoria.id}>
                                    ...
                                    <td>
                                        <span className={`estado ${categoria.estado.toLowerCase()}`}>
                                            {categoria.estado}
                                        </span>
                                    </td>
                                ...
                                <>
                                    ...
                                    <input
                                        ...
                                        onChange={(e) =>
                                            setModal({
                                                ...modal,
                                                categoria: { ...modal.categoria, nombre: e.target.value },
                                            })
                                        }
                                    />
