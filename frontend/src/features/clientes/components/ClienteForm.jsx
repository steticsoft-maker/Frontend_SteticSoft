...
// INICIO DE MODIFICACIÓN: Renombrar 'formErrors' a 'errors' para consistencia.
const ClienteForm = ({ formData, onFormChange, isEditing, errors }) => {
  // FIN DE MODIFICACIÓN
  ...
  return (
    <div className="clientes-form-grid">
      ...
      <div className="clientes-form-group-full-width">
        ...
        <input type="text" id="direccion" name="direccion" value={formData.direccion || ''} onChange={handleChange} placeholder="Dirección" className={errors?.direccion ? 'input-error' : ''} />
