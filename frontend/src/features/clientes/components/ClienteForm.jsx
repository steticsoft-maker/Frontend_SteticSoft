  ...
  return (
    <>
      <div className="admin-form-section">
        ...
        <div className="admin-form-row-2">
          ...
          <div className="admin-form-group">
            ...
            <input 
              ...
              required 
              className={`admin-form-input ${formErrors.apellido ? 'error' : ''}`} 
            />
            {formErrors.apellido && (
        ...
        <div className="admin-form-group">
          <label htmlFor="direccion" className="admin-form-label">Dirección:</label>
          <input 
            type="text" 
            id="direccion" 
            name="direccion" 
            ...
            className={`admin-form-input ${formErrors.direccion ? 'error' : ''}`} 
          />
        ...
        <div className="admin-form-row-2">
          <div className="admin-form-group">
            ...
            <input 
              ...
              required 
              className={`admin-form-input ${formErrors.telefono ? 'error' : ''}`} 
            />
            {formErrors.telefono && (
          ...
          <div className="admin-form-group">
            ...
            <input 
              ...
              onBlur={onFormBlur} 
              required 
              className={`admin-form-input ${formErrors.fechaNacimiento ? 'error' : ''}`} 
            />
            {formErrors.fechaNacimiento && (
              <span className="admin-form-error">{formErrors.fechaNacimiento}</span>
            )}
          </div>
        </div>
      </div>
        ...
        <div className="admin-form-row-2">
          <div className="admin-form-group">
            ...
            <select 
              ...
              onBlur={onFormBlur} 
              required 
              className={`admin-form-select ${formErrors.tipoDocumento ? 'error' : ''}`}
            >
            ...
            {formErrors.tipoDocumento && (
              <span className="admin-form-error">{formErrors.tipoDocumento}</span>
            )}
          </div>
          ...
          <div className="admin-form-group">
            ...
            <input 
              ...
              required 
              className={`admin-form-input ${formErrors.numeroDocumento ? 'error' : ''}`} 
            />
            {formErrors.numeroDocumento && (
              <span className="admin-form-error">{formErrors.numeroDocumento}</span>
            )}
          </div>
        </div>
      </div>
          ...
          <div className="admin-form-row-2">
            <div className="admin-form-group">
              ...
              <PasswordInput
                ...
                required
                className={`admin-form-input ${formErrors.contrasena ? 'error' : ''}`}
              />
              {formErrors.contrasena && (
                <span className="admin-form-error">{formErrors.contrasena}</span>
              )}
            </div>
            ...
            <div className="admin-form-group">
              ...
              <PasswordInput
                ...
                required
                className={`admin-form-input ${formErrors.confirmarContrasena ? 'error' : ''}`}
              />
              {formErrors.confirmarContrasena && (
                <span className="admin-form-error">{formErrors.confirmarContrasena}</span>
              )}
            </div>
          </div>
        </div>
