      ...
      {!isEditing && (
        <>
          <div className="clientes-form-group">
            ...
            <input type="password" id="contrasena" name="contrasena" value={formData.contrasena || ''} onChange={handleChange} placeholder="Contraseña" required className={formErrors.contrasena ? 'input-error' : ''} />
          ...
          <div className="clientes-form-group">
            ...
            <input type="password" id="confirmPassword" name="confirmPassword" value={formData.confirmPassword || ''} onChange={handleChange} placeholder="Confirmar Contraseña" required className={formErrors.confirmPassword ? 'input-error' : ''} />
